...
public class ProportionView3 extends View {
    ...
    public ProportionView3(Context context) {
        super(context);
    }

    public ProportionView3(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        //获取xml值
...
/*
        ...
        canvas.drawText("黄条："+initialValue + ""+"/"+mDouble+""+"%", mWide / 2, startY, mPaint3);//中间文字
